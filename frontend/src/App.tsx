...
import type {Alert,AlertDetail,AppNotification,DriftResponse,DriftReviewAction,LiveEvent,Metrics,Page} from './types';
...
const navigation=[['overview',LayoutDashboard,'Dashboard'],['alerts',ShieldCheck,'Detections'],['users',Users,'Identities'],['model',BrainCircuit,'Model health'],['drift',GitCompareArrows,'Drift monitor']] as const;
