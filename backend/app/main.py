...
from app.api import alerts, auth, drift, events, health, ingestion, metrics, models, profiles
...
for router in (auth.router, health.router, ingestion.router, events.router, alerts.router, profiles.router, metrics.router, drift.router, models.router):
