...
from app.api import alerts, auth, behavior, drift, events, health, ingestion, metrics, models, notifications, profiles, simulations, system
...
for router in (auth.router, health.router, ingestion.router, events.router, alerts.router, profiles.router, metrics.router, drift.router, behavior.router, models.router, simulations.router, notifications.router, system.router):
